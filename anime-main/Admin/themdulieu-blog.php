                    ...
                    <div class="rowadd">
                        <div class="col-75">
                            <div class="containeradd">
                                <form action="xulydulieu-blog.php" method="post">
                                    ...
                                    <div class="rowadd">
                                        <div class="col-50">
                                            ...
                                            <label><i class="fa fa-bars"></i> ẢNH</label>
                                                <input type="text" id="txt_anh" name="txt_anh" value="" placeholder=" Public/blog/aaa.jpg">
                                            <label><i class="fa fa-address-card-o"></i> TÊN BLOG</label>
                                                <input type="text" id="txt_tenblog" name="txt_tenblog" value="" placeholder=" aaaaaaa">
                                            <label><i class="fa fa-file"></i> MÔ TẢ</label>
                                                <input type="text" id="txt_mota" name="txt_mota" value="" placeholder=" aaaaaaa">
                                            <label><i class="fa fa-file"></i> MÔ TẢ INDEX</label>
                                                <input type="text" id="txt_motaindex" name="txt_motaindex" value="" placeholder=" aaaaaaa">
                                            <label><i class="fa fa-file"></i> LOẠI BLOG</label>
                                                <input type="text" id="txt_loaiblog" name="txt_loaiblog" value="" placeholder=" tinanime">
                                            <label><i class="fa fa-file"></i> NGÀY ĐĂNG</label>
                                                <input type="text" id="text_ngaydang" name="text_ngaydang" value="" placeholder=" 2021/06/15">
                                        </div>
                                    </div>
