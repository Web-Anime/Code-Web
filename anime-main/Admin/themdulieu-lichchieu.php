                    ...
                    <div class="rowadd">
                        <div class="col-75">
                            <div class="containeradd">
                                <form action="xulydulieu-lichchieu.php" method="post">
                                    ...
                                    <div class="rowadd">
                                        <div class="col-50">
                                            ...
                                            <label><i class="fa fa-user"></i> LỊCH CHIẾU</label>
                                                <input type="text" id="txt_lichchieu" name="txt_lichchieu" value="">    
                                            ...
                                            <label><i class="fa fa-file"></i> THỜI GIAN CHIẾU</label>
                                                <input type="text" id="txt_thoigianchieu" name="txt_thoigianchieu" value="">
                                            <label><i class="fa fa-file"></i> NGÀY CHIẾU    </label>
                                                <input type="text" id="txt_luotxem" name="txt_ngaychieu" value="">
                                        </div>
                                    </div>
