                    ...
                    <div class="rowadd">
                        <div class="col-75">
                            <div class="containeradd">
                                <form action="xulydulieu-nguoidung.php" method="post">
                                    ...
                                    <div class="rowadd">
                                        <div class="col-50">
                                            ...
                                            <label><i class="fa fa-bars"></i> TÊN TÀI KHOẢN</label>
                                                <input type="text" id="txt_anh" name="txt_username" value="" placeholder="Tên tài khoản">
                                            <label><i class="fa fa-address-card-o"></i> MẬT KHẨU</label>
                                                <input type="text" id="txt_tenblog" name="txt_password" value="" placeholder="Mật khẩu">
                                        </div>
                                    </div>
