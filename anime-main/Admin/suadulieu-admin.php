                    ...
                    <div class="rowadd">
                        <div class="col-75">
                            <div class="containeradd">
                                ...
                                ?>
                                <form action="xulysua-admin.php" method="post">
                                    <h3 style="text-align:center;color:white;font-weight:700;margin-bottom:10px;">SỬA BLOG</h3>
                                    <div class="rowadd">
                                        <div class="col-50">
                                            <label><i class="fa fa-user"></i> ID</label>
                                                <input type="text" name="txt_id"readonly value= "<?php echo $id ?>">
                                            <label><i class="fa fa-user"></i> TÀI KHOẢN</label>
                                                <input type="text" name="txt_admin" value= "<?php echo $admin ?>">
                                            <label><i class="fa fa-bars"></i> MẬT KHẨU</label>
                                                <input type="text" name="txt_pass" value= "<?php echo $pass ?>">
                                            ...
                                            <label><i class="fa fa-bars"></i> SỐ ĐIỆN THOẠI</label>
