...
<head>
    ...
    <title>Anime | Thể Loại Anime TRANG 2</title>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="product__page__content">
                        ...
                        <div class="row">
                            <?php
                                ...
                                $query=mysqli_query($conn,"select * from anime ORDER BY id DESC LIMIT 22, 40");
                    ...
                    <div class="product__pagination">
                        <a href="categories.php" class="current-page">1</a>
